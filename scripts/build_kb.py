...
_IS_MODEL_CACHED = setup_model_cache(_PROJECT_DIR)
if not _IS_MODEL_CACHED:
    print("Model 'BAAI/bge-m3' not found in cache. Downloading from HuggingFace...")
    print(f"Cache dir: {_PROJECT_DIR / '.model_cache'}")
