...
class Aircraft:
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "hours_since_a_check": self.hours_since_a_check,
            "hours_since_c_check": self.hours_since_c_check,
            "cycles_since_a_check": self.cycles_since_a_check,
            "last_a_check": self.last_a_check.isoformat() if self.last_a_check else None,
            "last_c_check": self.last_c_check.isoformat() if self.last_c_check else None,
            "last_d_check": self.last_d_check.isoformat() if self.last_d_check else None,
            "current_location": self.current_location,
            "current_zone": self.current_zone,
            "mel_items": self.mel_items,
